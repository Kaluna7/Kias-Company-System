...
export async function GET(req) {
  try {
    ...
    const safeFinances = await backfillGapRiskIdNoForApiPath(prisma, "finance", finances);
    ...
    return new Response(JSON.stringify({ data: safeFinances, meta: { total, page, pageSize } }), { status: 200 });
  } catch (err) {
