...
export async function GET(req) {
  try {
    ...
    const where = { department: "SECURITY L&P" };
  ...
  try {
    ...
    if (latest) {
      ...
      await prisma.worksheet_finance.create({
        data: { department: "SECURITY L&P", status_wp: body.statusWP !== undefined && body.statusWP !== "" ? body.statusWP : null },
      });
    }
