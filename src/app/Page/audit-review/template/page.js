  ...
  const scopeLimitations = [
    {
      ...
      description: "The research may be limited due to the unavailability of certain historical records that are essential for comprehensive analysis."
    },
    {
      title: "Restricted Areas",
      description: "Field studies may be constrained by restricted access to specific sites, such as private properties or secure facilities."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {/* Section 1: Objective of the Audit */}
