...
export default function OpsEvidence() {
  ...
  useEffect(() => {
    ...
    const fetchApData = async () => {
      try {
        ...
        const riskResponse = await fetch("/api/RiskAssessment/ops?status=published&includeAps=true");
        ...
        const evidenceResponse = await fetch("/api/evidence/ops?department=OPERATIONAL");
  ...
  const handleFileUpload = async (index, e) => {
    ...
    try {
      ...
      formData.append("department", "OPERATIONAL");

      const response = await fetch("/api/evidence/ops", {
        method: "POST",
        body: formData,
      });
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-[95%] mx-auto border border-gray-200">
            <div className="mb-6 space-y-2">
              ...
              <div className="flex flex-col gap-1 text-sm text-gray-700">
                <p><span className="font-semibold">DEPARTMENT:</span> OPERATIONAL</p>
                    ...
                    <tr>
                      <td colSpan="5" className="border border-gray-300 px-4 py-8 text-center text-gray-500">
                        <div className="space-y-3">
                          ...
                          <p className="text-sm">Please create risk data in <strong>Risk Assessment Dashboard → Operational</strong> first.</p>
