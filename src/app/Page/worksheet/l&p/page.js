  ...
  return (
    <main className="flex flex-row w-full h-full min-h-screen bg-[#E6F0FA]">
      ...
      <div className="flex flex-col flex-1">
        <SmallHeader label="B.1.7 WORKSHEET - SECURITY L&P" showSearch={false} />
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-7xl mx-auto">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                {/* Worksheet Title */}
                <div>
                  <h2 className="text-2xl font-bold text-gray-800 mb-4">B.1.7 WORKSHEET</h2>
                </div>
                ...
                <div>
                  ...
                  <div className="text-lg font-medium text-gray-800">SECURITY L&P</div>
                </div>
