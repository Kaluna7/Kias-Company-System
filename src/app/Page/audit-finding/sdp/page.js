  ...
  return (
    <main className="flex flex-row w-full h-full min-h-screen bg-[#E6F0FA]">
      ...
      <div className="flex flex-col flex-1">
        <SmallHeader label="B.2.5 AUDIT FINDING - STORE DESIGN PLANNER" showSearch={false} />
        <div className="mt-12 ml-14 flex-1 p-6">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-[95%] mx-auto">
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-bold text-gray-800">B.2.5 AUDIT FINDING STORE DESIGN PLANNER</h2>
